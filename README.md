...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-b24a90a-security`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-b24a90a-security --clone
cd dynamo-b24a90a-security
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-b24a90a-security --fill
```
